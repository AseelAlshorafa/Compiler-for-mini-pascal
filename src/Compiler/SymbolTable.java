...
public class SymbolTable {
    ...
    /**
     * Constructor of SymbolTable class. Initialize both localTable and globalTable,
     * allocating HashMaps.
     */
    public SymbolTable() {
    ...
    /**
     * Returns the object corresponding to the key. First search in localTable, and
     * if not found, search in globalTable.
     *
     * @param key
     * @return Object
     */
